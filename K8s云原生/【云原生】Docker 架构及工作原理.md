...
![在这里插入图片描述](https://img-blog.csdnimg.cn/905a15223bb24e22ba2dc8fef74162b0.png)
...
- 一个命令行界面(CLI)客户端(docker命令)。
  ![在这里插入图片描述](https://img-blog.csdnimg.cn/4344645de3204be58162bc0e93eb9d9a.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/bdd81f5b429b4d38bceaee781218a893.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/00172fd5de3d4554b2fe184736c34ea5.png)
...
## 九、总结
![在这里插入图片描述](https://img-blog.csdnimg.cn/373d06999dc643df8992478bd9d172cf.png)

Docker 官网写着这样一句话：Build and Ship any Application Anywhere，再结合刚才我们所理解的内容，总结下来就是：一次构建，到处运行。

此外，Docker 公司提供了公共的镜像仓库 [https://hub.docker.com](https://hub.docker.com)，GitHub connect，自动构建镜像，大大简化了应用分发、部署、升级流程。加上 Docker 可以非常方便的建立各种自定义的镜像文件，这些都是 Docker 成为最流行的容器技术的重要因素。
